// Load the Schema.org structured data into the page
// This script should be included in the HTML after loading schema.org-data.js
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Add schemas to the page - Create script elements for each schema
  const schemas = [productSchema, faqSchema, reviewSchema, organizationSchema, websiteSchema, serviceSchema];
  ...
  console.log('Schema.org structured data has been loaded into the page.');
});